; *** Ainu (Aynu itak) locale for ainuKey ***
;
; English base; the Ainu strings live in the installer .iss [Messages] (ainu.*),
; translated ONLY where attested Ainu exists (sourced inline from
; mkpoli/mediawiki-ainu-i18n and Ainu dictionaries via the Ainu MCP). Software-UI
; terms with no attested Ainu yet (Next, Install, ...) intentionally stay English
; rather than invent vocabulary; native-speaker contributions welcome.
;
