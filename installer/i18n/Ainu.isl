; *** Ainu (Aynu itak) — partial manual locale for ainuKey ***
;
; Based on Inno Setup's English Default.isl. Ainu strings are supplied via the
; installer .iss [Messages] section (ainu.* keys), using vetted vocabulary from
; the project and Ainu dictionaries (Kayano/Tamura/Nakagawa) via the Ainu MCP.
; Untranslated wizard strings fall back to English. Native-speaker review welcome.
;
